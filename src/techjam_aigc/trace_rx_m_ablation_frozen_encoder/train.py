...
from techjam_aigc.trace_rx_m_ablation_frozen_encoder.data import (
    BalancedTraceBatchSampler,
    TraceRXMDataset,
    load_training_manifest,
)
from techjam_aigc.trace_rx_m_ablation_frozen_encoder.quality import QUALITY_DIMENSION
from techjam_aigc.trace_rx_m_ablation_frozen_encoder.reliability import (
...
def _loader(frame: pd.DataFrame, repo_root: Path, config: TraceRXMConfig, *, augment: bool):
    ...
    if augment:
        from techjam_aigc.trace_rx_m_ablation_frozen_encoder.augment import SymmetricTransformSampler
...
def run_protocol(args: argparse.Namespace, config: TraceRXMConfig) -> None:
    from techjam_aigc.trace_rx_m_ablation_frozen_encoder.protocol import run_nuisance_probes
    from techjam_aigc.trace_rx_m_ablation_frozen_encoder.training import file_sha256
...
def run_cache(args: argparse.Namespace, config: TraceRXMConfig) -> None:
    torch = _torch()
    from techjam_aigc.trace_rx_m_ablation_frozen_encoder.backbone import DinoV3PatchEncoder
    from techjam_aigc.trace_rx_m_ablation_frozen_encoder.training import cache_patch_features, file_sha256
...
def run_capacity(args: argparse.Namespace, config: TraceRXMConfig) -> None:
    torch = _torch()
    from techjam_aigc.trace_rx_m_ablation_frozen_encoder.integrations import WandbTracker
    from techjam_aigc.trace_rx_m_ablation_frozen_encoder.training import (
...
def run_detection(args: argparse.Namespace, config: TraceRXMConfig) -> None:
    torch = _torch()
    from techjam_aigc.trace_rx_m_ablation_frozen_encoder.backbone import DinoV3PatchEncoder
    from techjam_aigc.trace_rx_m_ablation_frozen_encoder.integrations import (
